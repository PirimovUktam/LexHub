// LexHub — Legal AI proxy uchun master system prompt (server-side nusxa).
//
// MANBA: `lib/core/legal_safety/master_system_prompt.dart` (`MasterSystemPrompt.prompt`).
// Bu fayl o'sha matnning AYNAN nusxasi bo'lishi SHART — kalitni client'ga
// qo'ymaslik uchun model chaqiruvi serverda bajariladi, lekin xavfsizlik
// qoidalari (gallyutsinatsiyaga nol tolerantlik, prompt injection himoyasi,
// advokat o'rnini bosmaslik) ikki tomonda bir xil qolishi kerak.
//
// DRIFT QO'RIQCHISI: `test/core/security/legal_ai_prompt_parity_test.dart`
// ikkala matnni normalizatsiya qilib solishtiradi. Dart tomonda matn
// o'zgarsa va bu fayl yangilanmasa — test yiqiladi.
