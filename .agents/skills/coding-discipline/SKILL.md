...
|---|---|
| Taxminni fakt deb olma | `AGENTS.md` §0 CLAIM ≠ EVIDENCE; §14 no-false-success |
...
Karpathy `AGENTS.md` (behavioral guidelines), MIT —
https://x.com/karpathy/status/2015883857489522876

Upstream skill nomi `karpathy-guidelines`. Bu yerda LexHub `AGENTS.md` §0-§16
