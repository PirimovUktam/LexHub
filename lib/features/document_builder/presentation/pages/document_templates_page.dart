...
class _DocumentTemplatesPageState extends State<DocumentTemplatesPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) =>
          sl<DocumentBuilderBloc>()..add(const LoadTemplatesListEvent()),
      child: Scaffold(
        appBar: AppBar(
        ...
        body: AppPageBody(
            maxWidth: 1120,
            child: BlocBuilder<DocumentBuilderBloc, DocumentBuilderState>(
              builder: (context, state) {
                ...
                return Column(
                  children: [
                    ...
                    Container(
                      height:
                          52 * MediaQuery.textScalerOf(context).scale(14) / 14,
                          ...
                          if (state is DocumentTemplatesLoaded) {
                            ...
                            return AdaptiveCardList(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                final tone =
                                    AppTone.forRawAccent(template.color);
