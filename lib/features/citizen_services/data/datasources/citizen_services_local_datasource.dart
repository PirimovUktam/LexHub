...
class CitizenServicesLocalDataSourceImpl implements CitizenServicesLocalDataSource {
  static final List<CitizenService> _verifiedServices = [
    ...
    CitizenService(
      ...
      deadlineLawReference: "Mehnat kodeksi 560-modda (Ishga tiklash nizosi: uch oy; boshqa mehnat nizolari: olti oy; qonundagi istisnolar hisobga olinadi)",
      sourceUrl: "https://lex.uz/docs/6257288#6269139",
      ...
      steps: const [
        ...
        ServiceStep(
          ...
          warningNote: "Muddat nizoning turiga va qonunda nazarda tutilgan holatlarga bog'liq. Boshlanish sanasi, istisnolar va mediatsiya davrini yurist bilan tekshiring; bu qolgan vaqt hisob-kitobi emas.",
          stepType: 'appeal',
        ),
      ],
    ),
