                          ...
                          Wrap(
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  color: AppTone.accentIndigo
                                      .bg(isDark, alpha: 0.12),
                                  borderRadius: BorderRadius.circular(20),
                                  border: Border.all(
                                      color:
                                          AppTone.accentIndigo.border(isDark)),
                                ),
                                child: Row(
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  color:
                                      AppTone.warning.bg(isDark, alpha: 0.15),
                                  borderRadius: BorderRadius.circular(20),
                                  border: Border.all(
                                      color: AppTone.warning.border(isDark)),
                                ),
                                child: Row(
                                  mainAxisSize: MainAxisSize.min,
                                  children: [
                            ...
                            ListTile(
                              ...
                              leading: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  color:
                                      AppTone.neutral.bg(isDark, alpha: 0.10),
                            ...
                            if (role == UserRole.admin ||
                              ...
                              ListTile(
                                ...
                                leading: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color:
                                        AppTone.warning.bg(isDark, alpha: 0.10),
                                    borderRadius: BorderRadius.circular(10),
                                  ),
